...
typedef int (*st_zfs_iter_cb)(zfs_handle_t *, int, void *, boolean_t);
...
int st_zfs_for_each(int options, zfs_type_t,st_zfs_sort_column_t *, 
	zprop_list_t **, int, st_zfs_iter_cb, void *, boolean_t);
