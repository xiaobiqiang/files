...
//iscsit_sess_sm_event(result, SE_CONN_IN_LOGIN, ict) for conn_bind_sess and sess_bind_conn
//if is discovery session,tgt is NULL, add to global.discovery_session, otherwise
//add to tgt->sess_list
iscsit_sess_t *
