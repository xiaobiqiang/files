...
//*ic->ic_conn_ops.icb_client_notify)(ic, cn, NULL) :iscsit_client_notify
//ic->ic_transport_ops->it_tgt_conn_connect(ic)	:idm_so_tgt_conn_connect
idm_status_t
...
/* 
 * TODO: ldi_open_by_name
 * for IB, get IB's block_device handle
 * for tcp, do nothing
 */
void
