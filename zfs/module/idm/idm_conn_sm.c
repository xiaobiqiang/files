...
//target:
//		CS_S3_XPT_UP 		:when accept,going to notify client
//		CS_S9A_REJECTED		:accept rejected by notify_client
//		CS_S9_INIT_ERROR	:accept failed due to some unknown errors
//		CS_S4_IN_LOGIN		:accept LOGIN_CMD pdu after accepting.	
static void
idm_update_state(idm_conn_t *ic, idm_conn_state_t new_state,
    idm_conn_event_ctx_t *event_ctx)
{
