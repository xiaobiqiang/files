 ...
 */
/* create a new it_tgt_t and append to cfg->config_tgt_list */
int
 ...
 */
/* pick up a suitable tagid and new a it_tpgt_t then append to tgt->tgt_tpgt_list */
int
...
it_iqn_generate(char *iqn_buf, int iqn_buf_len, char *opt_iqn_suffix)
{
	...
	if (opt_iqn_suffix) {
		ret = snprintf(iqn_buf, iqn_buf_len, "iqn.1986-03.com.csd:"
