...
typedef enum {
	...
	/* Target events */
	CE_CONNECT_ACCEPT,	//accept peer
	CE_CONNECT_REJECT,	//accept rejected by notify_client
	CE_LOGIN_RCV,		//recv LOGIN_CMD pdu after accepting
	CE_LOGIN_TIMEOUT,	//when accept, don't login during assigned time(20s).
...
typedef enum {
	...
	CS_S1_FREE,		/* handler occurred in this state: idm_state_s1_free */
	CS_S2_XPT_WAIT,
	CS_S3_XPT_UP,
	CS_S4_IN_LOGIN,
	CS_S5_LOGGED_IN,
